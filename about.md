---
layout: page
title: About Born2Fly
subtitle: Where Possibility Meets Movement
permalink: /about/
description: "Learn about Born2Fly Gymnastics, our mission to empower every child through adaptive gymnastics across KwaZulu-Natal."
---
...
Basic gymnastic skills include:

- **Rolls & Cartwheels** – Building momentum and spatial awareness
- **Balance & Body Posture** – Core strength and alignment
- **Jumping & Bunny Jumps** – Explosive power and coordination
- **Body Co-ordination & Ball Play** – Hand-eye integration
- **Strength & Flexibility** – Physical conditioning
- **Apparatus Use** – Confidence with equipment

---

## Therapeutic Benefits

Born2Fly proudly caters for children with special needs and has many years of experience working with children of all abilities. These activities are ideal for children requiring Occupational Therapy (OT). Children are encouraged to participate in activities with fun presentation and the camaraderie of their fellow pupils. All activities are presented in a fun and safe manner, supporting children's physical and emotional development.
...
To secure a spot for your child, please complete our registration form. A registration fee will be expected upon registration.

**Cancellation Policy**: Please give one month's written notice if you wish to cancel your child's membership.

<div class="section-cta text-center" style="margin-top: 3rem;">
  <a href="{{ '/contact/' | relative_url }}" class="btn btn-primary btn-lg">Work With Born2Fly</a>
</div>
